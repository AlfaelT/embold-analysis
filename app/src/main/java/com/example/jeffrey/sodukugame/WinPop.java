...
public class WinPop extends Activity {
    Button tryButton;
    Button diffButton;
    TextView playerTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tryButton.setOnClickListener(new View.OnClickListener() {
            public void onClick (View v) {
                Intent tryIntent = new Intent(WinPop.this,EasySoduku.class);
        ...
        diffButton.setOnClickListener(new View.OnClickListener() {
            public void onClick (View v) {
                Intent diffIntent = new Intent(WinPop.this,SodukuGameMenu.class);
                startActivity(diffIntent);
            }

        }) ;
        playerTime = (TextView) findViewById(R.id.player_time);
        playerTime.setText(EasySoduku.time.getText());
