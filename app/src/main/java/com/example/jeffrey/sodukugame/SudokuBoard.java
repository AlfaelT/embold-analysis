...
return  board;
    ...
    public static boolean checkHorizontal(int a, int[][] board, int number, boolean checkerH) {
            ArrayList<Integer> horizontalArray = new ArrayList<Integer>();
            for (int c = 0; c < board[a].length; c++) {
                horizontalArray.add(board[a][c]);
            }
            for (int d = 0; d < horizontalArray.size(); d++) {
                if (number != horizontalArray.get(d)) {
                    checkerH = true;
                } else if (number == horizontalArray.get(d)) {
                        checkerH = false;
                        break;
    ...
    public static boolean checkHorizontalTwo(int a, int[][] board, int number, boolean checkerH) {
        ArrayList<Integer> horizontalArrayTwo = new ArrayList<Integer>();
        int counterTwo = 0;
        for (int c = 0; c < board[a].length; c++) {
            horizontalArrayTwo.add(board[a][c]);
        }
        for (int d = 0; d < horizontalArrayTwo.size(); d++) {
           if (number == horizontalArrayTwo.get(d)) {
                counterTwo++;
                if(counterTwo == 1) {
                    checkerH = true;
                }
    ...
    public static boolean checkVerticalTwo(int b, int[][] board, int number, boolean checkerV) {
        ArrayList<Integer> verticalArrayTwo = new ArrayList<Integer>();
        int counterTwo = 0;
        for (int c = 0; c < 9; c++) {
            verticalArrayTwo.add(board[c][b]);
        }
        for (int d = 0; d < verticalArrayTwo.size(); d++) {
             if (number == verticalArrayTwo.get(d)) {
                counterTwo++;
                if(counterTwo == 1) {
                    checkerV = true;
                }
    ...
    public static boolean checkBoxTwo(int a, int b, int[][] board, int number, boolean checkerB) {
        ArrayList<Integer> boxArray = new ArrayList<Integer>();
        int counterTwo = 0;
        if (a <= 2 && b <= 2) {
            for (int c = 0; c < 3; c++) {
